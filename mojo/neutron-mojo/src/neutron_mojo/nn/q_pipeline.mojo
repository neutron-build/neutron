# ===----------------------------------------------------------------------=== #
# Neutron Mojo — Quantized Generation Pipeline
# ===----------------------------------------------------------------------=== #

"""Text-in -> text-out generation pipeline for QuantizedModel.

Mirrors pipeline.mojo but uses QuantizedModel (Q8) for inference.
...
# ===----------------------------------------------------------------------=== #
# Quantized Pipeline Generate
# ===----------------------------------------------------------------------=== #

def q_pipeline_generate(
    model: QuantizedModel,
    tokenizer: BPETokenizer,
    prompt: String,
    config: PipelineConfig,
) raises -> String:
    """Generate text from a prompt using the quantized pipeline.
    ...
    Args:
        model: The Q8 quantized language model.
