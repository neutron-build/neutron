...
struct Shape(Writable, Copyable, Movable, ImplicitlyCopyable):
    ...
    def broadcast_with(self, other: Shape) raises -> Shape:
    ...
    def reshape_valid(self, new_shape: Shape) -> Bool:
