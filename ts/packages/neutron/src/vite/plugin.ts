...
import { renderDocumentHead, mergeSeoMetaInput } from "../core/seo.js";
...
async function handleRequest(
  ...
  const headHtml = await resolveDevHeadHtml(allRoutes, moduleCache, {
    request,
    params,
    context,
    loaderData,
  ...
  try {
    ...
    const fullHtml = wrapHtml(html, route, request, loaderData, actionData, headHtml);
