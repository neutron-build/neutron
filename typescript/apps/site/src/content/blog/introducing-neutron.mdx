...
The Rust framework targets high-throughput APIs, WebSocket servers, and anything where latency predictability matters. Trie-based routing, 18 composable crates, JWT auth, WebSocket, SSE — all tested across 1,161 tests.
...
**3,300+ passing tests across four languages.** TypeScript, Rust, Python, and Mojo all have comprehensive test suites. Go and Zig are built but have lighter test coverage.

**Nucleus: 149,000+ lines of Rust, 3,724 tests.** WAL durability on all fourteen models. MVCC snapshot isolation in memory mode. Disk MVCC and distributed mode are in progress.
