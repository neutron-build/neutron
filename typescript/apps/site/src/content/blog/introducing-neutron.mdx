...
**Nucleus at launch (2026-02-15): 234,621 lines of Rust, 2,596 tests.** WAL durability on 8 of the 14 models. MVCC snapshot isolation in memory mode. Disk MVCC and distributed mode are in progress. These are the figures as of this post's date and are not updated in place — see the [README](https://github.com/neutron-build/neutron) for current counts.
