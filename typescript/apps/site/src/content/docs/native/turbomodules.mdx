...
TurboModules use React Native's JSI (JavaScript Interface) to call native code without the legacy JSON bridge. Synchronous methods execute from the JavaScript thread; asynchronous methods return promises backed by native dispatch.
