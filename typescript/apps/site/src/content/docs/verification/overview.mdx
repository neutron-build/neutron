...
| Guarantee | "No bugs found" | "No bugs can exist" |
| Edge cases | Must think of them | Proven for all cases |
...
### [Verus](/docs/verification/verus) — Full Correctness Proofs (Coming Soon)
